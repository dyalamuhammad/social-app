        ...
        <div class="mx-md-auto col-12 col-md-8 col-lg-5 border-bottom mb-3">
            <div class="d-flex p-2 justify-content-between">
                <div class="d-flex gap-3">
                    ...
                    @endphp
                    @if ($userImage)
                        <img src="{{ asset($userImage) }}" alt="" class="rounded-circle" width="45px" height="45px"
                ...
                <div class="modal-body">
                    <div class="col-12 text-center">
                        <form action="{{ route('delete-post') }}" method="post">
                            ...
                            <div class="col-12">
                                <button type="submit" class="text-center btn text-danger col-12">Delete Post</button>
                            </div>
                        </form>
                    </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body p-0 row">
                    ...
                    <div class="col-12 col-lg-6 pt-2 ps-2 ps-lg-0">
                        <div class="h-100">
                            <div class="mb-4 border-bottom  py-2 border-secondary d-none d-lg-flex ps-2 sticky-top bg-dark">
                                <div class="col-2 col-xxl-1">
