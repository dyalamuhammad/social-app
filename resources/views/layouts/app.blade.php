    ...
    <div class="container-fluid ">
        <div class="row d-md-none fixed-top">
            <div class="col-12 py-2 bg-dark">
                <a class="navbar-brand ms-3 title-brand fs-3 fw-semibold text-white"
                    href="#">{{ $title }}</a>
            </div>
        </div>
        <div class="row min-vh-100 my-5 my-md-0">
            <div
                    ...
                    <ul class="navbar-nav text-center text-lg-start">
                        <li class="nav-item"><a href="{{ route('home') }}"
                                class="nav-link {{ Route::is('home') ? 'active' : '' }}"><i
                                    class="bi {{ Route::is('home') ? 'bi-house-door-fill' : 'bi-house-door' }} align-middle fs-3 me-lg-3"></i>
                        ...
                        <li class="nav-item"><a href="{{ route('explore') }}"
                                class="nav-link {{ request()->is('explore') ? 'active' : '' }}"><i
                                    class="bi bi-search {{ request()->is('explore') ? 'text-white' : '' }} align-middle fs-3 me-lg-3"></i>
                                <span class="d-none d-lg-inline">Search</span></a>
                        </li>
                        <li class="nav-item"><a href="{{ route('profile', ['id' => $user->id]) }}"
                                class="nav-link d-flex gap-3 {{ request()->is('profile/' . $user->id) ? 'active' : '' }}">
                ...
                <ul class="navbar-nav text-center">
                    <li class="nav-item"><a href="{{ route('doLogout') }}" class="nav-link "><i
                                class="bi bi-box-arrow-right align-middle fs-3 me-lg-3"></i> <span
    ...
    <div class="fixed-bottom d-block d-md-none border-top border-secondary py-2 bg-dark m-0">
        <div class="d-flex justify-content-evenly">
            ...
            <a href="{{ route('profile', ['id' => $user->id]) }}" class="nav-link align-self-center">
                ...
                <img src="{{ asset($user->img) }}" alt="" class="rounded-circle" style="object-fit: cover"
                    width="35px" height="35px">

            </a>
            <a href="{{ route('doLogout') }}" class="nav-link align-self-center"><i
                    class=" fs-4 bi bi-box-arrow-right"></i></a>
        </div>
